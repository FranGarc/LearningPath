...
import com.franciscogarciagarzon.learningpath.ui.common.components.AbilityComponent
...
fun PokemonInfoAbout(
    ...
    val typeColors: List<Color> = pokemonArticleUi.typeColorsForAbilities()
    ...
    Column(
        modifier = Modifier
            .draggable(
                ...
                onDragStopped = {
                    ...
                    updateTabIndexBasedOnSwipe(PokemonArticleUserEvent.OnSwipedTab(isSwipeToTheLeft))
                }
            )
    ) {
        ...
        Row(
            ...
            Column(modifier = Modifier.padding(start = paddingBetweenColumns)) {
                Row(
                    ...
                    RegularLabel(text = pokemonArticleUi.printableHeight())
                }
                Row(
                    modifier = Modifier
                        .padding(top = paddingRowTop)
                ) {
                    RegularLabel(text = pokemonArticleUi.printableWeight())
                }
        ...
        Row(
            ...
            val abilitiesAmount = pokemonArticleUi.abilities.size
            ...
            pokemonArticleUi.abilities.forEach { abilityUi ->
                AbilityComponent(
...
fun PokemonInfoAboutPreview() {
    PokemonInfoAbout(
        ...
        pokemonArticleUi = MockDataSource().getPokemonArticle().toPokemonArticleUi(),
