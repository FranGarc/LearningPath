...
import com.franciscogarciagarzon.learningpath.data.remote.model.toPokemonList
...
class RemoteDataSource @Inject constructor(private val pokemonService: PokemonService) : DatasourceAdapter {
    override suspend fun getPokemonList(): Flow<Result<PokedexIndexList>> {
    ...
    override suspend fun getPokemonDetail(id: String): Flow<Result<PokemonArticle>> {
